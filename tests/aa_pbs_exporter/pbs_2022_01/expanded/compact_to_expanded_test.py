...
from aa_pbs_exporter.pbs_2022_01.compact_to_expanded import Translator as CompactTranslator

def test_raw_to_expanded(test_app_data_dir: Path):
    outpath = test_app_data_dir / "compact" / "raw_to_compact"
    ...
    raw_package = parse_raw_bidpackage(strings=lines, manager=manager,source="three_pages")
    raw_json_path = outpath/"three_pages_raw.json"
    ...
    compact_json_path = outpath/"three_pages_compact.json"
    ...
    expanded_json_path = outpath/"three_pages_expanded.json"
