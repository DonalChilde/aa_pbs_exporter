...
class CollectResults:
    """Collects ParseResults."""

    def __init__(self, metadata: dict[str, Any] | None = None) -> None:
        self.collected_results: CollectedParseResults = {"metadata": {}, "data": []}
        self.metadata = metadata
        if self.metadata is not None:
            self.collected_results["metadata"].update(self.metadata)
    ...
    def handle_result(
        ...
        self.collected_results["data"].append(parse_result)
