...
from aa_pbs_exporter.pbs_2022_01.messengers.status_print_messenger import (
    StatusPrintMessenger,
)
...
def init_msg_bus(debug_fp: TextIOWrapper | None = None, click_out: bool = False):
    ...
    print_messenger = StatusPrintMessenger()
    msg_bus.consumers.append(print_messenger)
    return msg_bus
